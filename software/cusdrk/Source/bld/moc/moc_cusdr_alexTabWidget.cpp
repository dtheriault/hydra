...
struct qt_meta_stringdata_AlexTabWidget_t {
    QByteArrayData data[5];
    char stringdata[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AlexTabWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AlexTabWidget_t qt_meta_stringdata_AlexTabWidget = {
    {
...
QT_MOC_LITERAL(4, 40, 23)
    ...
    "AlexTabWidget\0sizeHint\0\0minimumSizeHint\0"
    "addNICChangedConnection"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_AlexTabWidget[] = {
...
void AlexTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AlexTabWidget *_t = static_cast<AlexTabWidget *>(_o);
        switch (_id) {
...
const QMetaObject AlexTabWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_AlexTabWidget.data,
      qt_meta_data_AlexTabWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AlexTabWidget.stringdata))
        return static_cast<void*>(const_cast< AlexTabWidget*>(this));
