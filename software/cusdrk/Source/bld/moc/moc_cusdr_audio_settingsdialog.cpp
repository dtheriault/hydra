...
#include "../../src/AudioEngine/cusdr_audio_settingsdialog.h"
...
QT_MOC_LITERAL(4, 41, 19)
    ...
    "SettingsDialog\0inputDeviceChanged\0\0"
    "index\0outputDeviceChanged"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->inputDeviceChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->outputDeviceChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
