...
struct qt_meta_stringdata_ReceiverWidget_t {
    QByteArrayData data[5];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ReceiverWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ReceiverWidget_t qt_meta_stringdata_ReceiverWidget = {
    {
...
QT_MOC_LITERAL(4, 33, 10)
    ...
    "ReceiverWidget\0showEvent\0\0sender\0"
    "closeEvent"
};
...
void ReceiverWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ReceiverWidget::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReceiverWidget::showEvent)) {
                *result = 0;
            }
        }
        {
            typedef void (ReceiverWidget::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReceiverWidget::closeEvent)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ReceiverWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ReceiverWidget.data,
      qt_meta_data_ReceiverWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ReceiverWidget.stringdata))
...
struct qt_meta_stringdata_MiniReceiverWidget_t {
    QByteArrayData data[5];
    char stringdata[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MiniReceiverWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MiniReceiverWidget_t qt_meta_stringdata_MiniReceiverWidget = {
    {
...
QT_MOC_LITERAL(4, 37, 10)
    ...
    "MiniReceiverWidget\0showEvent\0\0sender\0"
    "closeEvent"
};
#undef QT_MOC_LITERAL
...
void MiniReceiverWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (MiniReceiverWidget::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MiniReceiverWidget::showEvent)) {
                *result = 0;
            }
        }
        {
            typedef void (MiniReceiverWidget::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MiniReceiverWidget::closeEvent)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject MiniReceiverWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MiniReceiverWidget.data,
      qt_meta_data_MiniReceiverWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MiniReceiverWidget.stringdata))
