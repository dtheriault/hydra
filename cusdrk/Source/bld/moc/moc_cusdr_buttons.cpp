...
#include "../../src/Util/cusdr_buttons.h"
...
struct qt_meta_stringdata_AeroButton_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AeroButton_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AeroButton_t qt_meta_stringdata_AeroButton = {
    {
...
const QMetaObject AeroButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_AeroButton.data,
      qt_meta_data_AeroButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AeroButton.stringdata))
